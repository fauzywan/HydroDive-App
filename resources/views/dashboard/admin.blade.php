<x-layouts.app :title="__('Dashboard')">
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        ...
        <div class="grid auto-rows-min gap-4 md:grid-cols-3">
            ...
            <!-- Total Kompetisi -->
            <div class="rounded-xl border border-gray-200 p-4 shadow-sm bg-white dark:border-neutral-700 dark:bg-neutral-900">
                <h2 class="text-lg font-semibold text-gray-800 dark:text-white mb-2">Jumlah Club</h2>
        ...
        <div class="grid md:grid-cols-2 gap-4 items-start">
            ...
            @empty
                ...
                <div class="flex justify-center items-center">
                    <flux:button variant="primary" class="hover:text-blue-500 text-sm bg-blue-500 w-full text-white font-bold" href="/athlete" ><b>Lihat Lebih Banyak</b></flux:button>
                </div>
                @endif
            </ul>
            </div>
            ...
            <!-- Jadwal Latihan -->
            <div class="rounded-xl border border-gray-200 p-4 shadow-sm bg-white dark:border-neutral-700 dark:bg-neutral-900">
                <h3 class="text-xl font-bold text-gray-800 dark:text-white mb-4">Event Berlangsung</h3>
                <ul class="space-y-3">
                    @forelse ($event_berlangsung as $eb)
                        <li class="border-b pb-2">
                            <a href="/event/{{ $eb->id }}/detail" class="font-semibold">{{ $eb->name}}</a>
                ...
                @if ($event_berlangsung->count()>0)
                <div class="flex justify-center items-center mt-5">
                    <flux:button variant="primary" class="hover:text-blue-500 text-sm bg-blue-500 w-full text-white font-bold" href="/event"><b>Lihat Lebih Banyak</b></flux:button>
                </div>
                @endif
            </div>
        </div>
